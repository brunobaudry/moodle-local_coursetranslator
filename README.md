...
You can install a [tour guide](https://github.com/brunobaudry/moodle-local_coursetranslator/blob/main/tourguide/tour_export.json) to simplify your translators's trainings.
